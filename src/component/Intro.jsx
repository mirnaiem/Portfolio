...
const Intro = () => {
 return (
  <div className="mt-20 mb-6 grid grid-cols-1 md:grid-cols-2 gap-6">
  <div className="bg-[#191919]  rounded-3xl flex flex-col md:flex-row items-center ">
   <img className="p-1 md:p-10 w-4/5  round" src="https://i.ibb.co/g7gKfyY/IMG-20211216-WA0003-removebg-preview-2.png" alt="" />
   <div className='md:pe-10 pb-4 md:pb-0 pe-2 ps-2 md:ps-0'>
  ...
  <div className='text-white'>
   ...
   <div className='flex flex-col gap-5'>
    ...
    <div className='bg-[#191919] px-4 py-6 rounded-3xl relative'>
       ...
       <h2 className='absolute top-0 left-[28%]  z-0 text-3xl text-[#575757] font-extrabold'>MY WORKS</h2>
